...
{
    return cslibs_ndt::serialization::saveBinary<option_t,2,data_t,T,backend_t>(map,path);
}
...
{
    return cslibs_ndt::serialization::loadBinary<option_t,2,data_t,T,backend_t>(path,map);
}
