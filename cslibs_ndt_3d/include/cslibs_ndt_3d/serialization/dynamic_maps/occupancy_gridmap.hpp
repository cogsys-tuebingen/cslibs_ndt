...
/*
    ...
    using binary_t   = cslibs_ndt::binary<cslibs_ndt::OccupancyDistribution, T, 3, 3>;
...
{
    using target_ptr_t = typename cslibs_ndt::map::GenericMap<cslibs_ndt::map::tags::dynamic_map,3,cslibs_ndt::OccupancyDistribution,T,
    ...
    return cslibs_ndt::serialization::loadBinary<cslibs_ndt::map::tags::dynamic_map,3,cslibs_ndt::OccupancyDistribution,T>(path, m);
/*
    using path_t           = boost::filesystem::path;
    using paths_t          = std::array<path_t, 8>;
    using map_t            = cslibs_ndt_3d::dynamic_maps::OccupancyGridmap<T>;
