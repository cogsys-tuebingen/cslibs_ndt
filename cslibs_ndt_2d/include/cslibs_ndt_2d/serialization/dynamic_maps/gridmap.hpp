...
{
    return cslibs_ndt::serialization::saveBinary<cslibs_ndt::map::tags::dynamic_map,2,cslibs_ndt::Distribution,T>(map, path);

    /*
    using path_t     = boost::filesystem::path;
    using paths_t    = std::array<path_t, 4>;
    using map_t      = cslibs_ndt_2d::dynamic_maps::Gridmap<T>;
    using binary_t   = cslibs_ndt::binary<cslibs_ndt::Distribution, T, 2, 2>;
...
{    
    using target_ptr_t = typename cslibs_ndt::map::GenericMap<cslibs_ndt::map::tags::dynamic_map,2,cslibs_ndt::Distribution,T,
    ...
    return cslibs_ndt::serialization::loadBinary<cslibs_ndt::map::tags::dynamic_map,2,cslibs_ndt::Distribution,T>(path, m);
