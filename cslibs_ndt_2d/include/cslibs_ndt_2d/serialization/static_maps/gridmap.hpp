...
template <typename T>
inline bool saveBinary(const cslibs_ndt_2d::static_maps::Gridmap<T>::Ptr &map,
                       const std::string &path)
{
    using path_t     = boost::filesystem::path;
    using paths_t    = std::array<path_t, 4>;
    using map_t      = cslibs_ndt_2d::static_maps::Gridmap<T>;
...
inline bool loadBinary(const std::string &path,
                       cslibs_ndt_2d::static_maps::Gridmap<T>::Ptr &map)
{
    using path_t           = boost::filesystem::path;
    using paths_t          = std::array<path_t, 4>;
    using map_t            = cslibs_ndt_2d::static_maps::Gridmap<T>;
