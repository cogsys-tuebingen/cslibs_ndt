                       ...
                       cslibs_ndt_3d::dynamic_maps::Gridmap::Ptr &map)
{
    ...
    map.reset(new cslibs_ndt_3d::dynamic_maps::Gridmap(origin, resolution,
                                                       bundles,
                                                       storages,
                                                       min_index,
                                                       max_index));
...
inline bool save(const cslibs_ndt_3d::dynamic_maps::Gridmap::Ptr &map,
                 const std::string &path)
{
    using path_t  = boost::filesystem::path;
    using paths_t = std::array<path_t, 8>;
    using index_t = std::array<int, 3>;
    using distribution_storage_ptr_t = cslibs_ndt_3d::dynamic_maps::Gridmap::distribution_storage_ptr_t;
...
inline bool load(cslibs_ndt_3d::dynamic_maps::Gridmap::Ptr &map,
                 const std::string &path)
{
    using path_t  = boost::filesystem::path;
    using paths_t = std::array<path_t, 8>;
