...
{
    return cslibs_ndt::serialization::saveBinary<cslibs_ndt::map::tags::dynamic_map,3,cslibs_ndt::Distribution,T>(map, path);
}
...
{
    using target_ptr_t = typename cslibs_ndt::map::GenericMap<cslibs_ndt::map::tags::dynamic_map,3,cslibs_ndt::Distribution,T,
    ...
    return cslibs_ndt::serialization::loadBinary<cslibs_ndt::map::tags::dynamic_map,3,cslibs_ndt::Distribution,T>(path, m);
}
