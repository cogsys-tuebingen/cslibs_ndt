#ifndef CSLIBS_NDT_3D_MATCHING_NLOPT_OCCUPANCY_GRIDMAP_FUNCTION_HPP
#define CSLIBS_NDT_3D_MATCHING_NLOPT_OCCUPANCY_GRIDMAP_FUNCTION_HPP
...
public:
    ...
    inline static double applyRPY(unsigned n, const double *x, double *grad, void* ptr)
    {
        ...
        for (const auto& p : points) {
            ...
            fi += 1.0 - map.sampleNonNormalized(q,ivm);
        }
...
#endif // CSLIBS_NDT_3D_MATCHING_NLOPT_OCCUPANCY_GRIDMAP_FUNCTION_HPP
