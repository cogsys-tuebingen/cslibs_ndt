...
public:
    ...
    using distribution_bundle_t             = Bundle<distribution_t*, 4>;
    using distribution_const_bundle_t       = Bundle<const distribution_t*, 4>;
    ...
    inline cslibs_math_2d::Point2d getMin() const
    {
        ...
        return cslibs_math_2d::Point2d(min_index_[0] * bundle_resolution_,
    ...
    {
        lock_t l(bundle_storage_mutex_);
        return cslibs_math_2d::Point2d((max_index_[0] + 1) * bundle_resolution_,
...
protected:
    ...
    inline index_t toBundleIndex(const cslibs_math_2d::Point2d &p_w) const
    {
        const cslibs_math_2d::Point2d p_m = m_T_w_ * p_w;
