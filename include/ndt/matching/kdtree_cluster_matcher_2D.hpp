#ifndef KDTREE_CLUSTER_MATCHER_2D_HPP
#define KDTREE_CLUSTER_MATCHER_2D_HPP
...
namespace ndt {
namespace matching {
class KDTreeClusterMatcher2D : public Matcher<2> {
public:
    ...
    KDTreeClusterMatcher2D(const Parameters &params = Parameters()) :
        BaseClass(params),
        tree_interface(params.resolution)
    {
    }

    virtual ~KDTreeClusterMatcher2D()
    {
    }
...
#endif // KDTREE_CLUSTER_MATCHER_2D_HPP
