...
inline bool saveBinary(const cslibs_ndt_2d::dynamic_maps::WeightedOccupancyGridmap::Ptr &map,
                       const std::string &path)
{
    using path_t     = boost::filesystem::path;
    using paths_t    = std::array<path_t, 4>;
    using index_t    = cslibs_ndt_2d::dynamic_maps::WeightedOccupancyGridmap::index_t;
    using storages_t = cslibs_ndt_2d::dynamic_maps::WeightedOccupancyGridmap::distribution_storage_array_t;
    using binary_t   = cslibs_ndt::binary<cslibs_ndt::WeightedOccupancyDistribution, 2, 2>;
...
inline bool loadBinary(const std::string &path,
                       cslibs_ndt_2d::dynamic_maps::WeightedOccupancyGridmap::Ptr &map)
{
    using path_t           = boost::filesystem::path;
    using paths_t          = std::array<path_t, 4>;
    using index_t          = cslibs_ndt_2d::dynamic_maps::WeightedOccupancyGridmap::index_t;
    using binary_t         = cslibs_ndt::binary<cslibs_ndt::WeightedOccupancyDistribution, 2, 2>;
    using bundle_storage_t = cslibs_ndt_2d::dynamic_maps::WeightedOccupancyGridmap::distribution_bundle_storage_t;
    using storages_t       = cslibs_ndt_2d::dynamic_maps::WeightedOccupancyGridmap::distribution_storage_array_t;
    ...
    auto allocate_bundle = [&storages, &bundles](const index_t &bi) {
        cslibs_ndt_2d::dynamic_maps::WeightedOccupancyGridmap::distribution_bundle_t b;
    ...
    map.reset(new cslibs_ndt_2d::dynamic_maps::WeightedOccupancyGridmap(origin,
                                                                        resolution,
                                                                        min_index,
                                                                        max_index,
                                                                        bundles,
