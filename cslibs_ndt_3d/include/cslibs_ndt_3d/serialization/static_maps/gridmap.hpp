...
{
    return cslibs_ndt::serialization::binary<cslibs_ndt::map::tags::static_map,3,cslibs_ndt::Distribution,T>::save(*map, path);
}
...
{
    return cslibs_ndt::serialization::binary<cslibs_ndt::map::tags::static_map,3,cslibs_ndt::Distribution,T>::load(path, map);
}
}
}
