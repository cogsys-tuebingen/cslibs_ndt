                       ...
                       const std::string &path)
{
    ...
    using map_t      = cslibs_ndt_2d::dynamic_maps::WeightedOccupancyGridmap<T>;
    using binary_t   = cslibs_ndt::binary<cslibs_ndt::WeightedOccupancyDistribution, T, 2, 2>;
...
{
    using target_ptr_t = typename cslibs_ndt::map::GenericMap<cslibs_ndt::map::tags::dynamic_map,2,cslibs_ndt::WeightedOccupancyDistribution,T,
    ...
    return cslibs_ndt::serialization::loadBinary<cslibs_ndt::map::tags::dynamic_map,2,cslibs_ndt::WeightedOccupancyDistribution,T>(path, m);
