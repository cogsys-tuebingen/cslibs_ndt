...
inline bool save(const cslibs_ndt_3d::static_maps::OccupancyGridmap::Ptr &map,
                 const std::string &path)
{
    using path_t  = boost::filesystem::path;
    using paths_t = std::array<path_t, 8>;
    using index_t = std::array<int, 3>;
    using distribution_storage_ptr_t = cslibs_ndt_3d::static_maps::OccupancyGridmap::distribution_storage_ptr_t;
    ...
    for (std::size_t i = 0 ; i < 8 ; ++ i) {
        ...
        cslibs_ndt_3d::dynamic_maps::OccupancyGridmap::distribution_storage_ptr_t storage_kd(
                    new cslibs_ndt_3d::dynamic_maps::OccupancyGridmap::distribution_storage_t());

        storage->traverse([&storage_kd](const index_t &index, const typename cslibs_ndt_3d::static_maps::OccupancyGridmap::distribution_t &data) {
...
inline bool load(cslibs_ndt_3d::static_maps::OccupancyGridmap::Ptr &map,
                 const std::string &path)
{
    using path_t  = boost::filesystem::path;
    using paths_t = std::array<path_t, 8>;
...
namespace YAML {
template <>
struct convert<cslibs_ndt_3d::static_maps::OccupancyGridmap::Ptr>
{
    using map_t = cslibs_ndt_3d::static_maps::OccupancyGridmap;
    static Node encode(const typename map_t::Ptr &rhs)
    {
        ...
        typename cslibs_ndt_3d::dynamic_maps::OccupancyGridmap::distribution_storage_t;
        using distribution_storage_ptr_t =
        typename cslibs_ndt_3d::dynamic_maps::OccupancyGridmap::distribution_storage_ptr_t;
