...
class EIGEN_ALIGN16 WeightedOccupancyGridmap : public GenericMap<option_t,Dim,WeightedOccupancyDistribution,T,backend_t>
{
public:
    EIGEN_MAKE_ALIGNED_OPERATOR_NEW
    using allocator_t = Eigen::aligned_allocator<WeightedOccupancyGridmap<option_t,Dim,T,backend_t>>;

    using ConstPtr = std::shared_ptr<const WeightedOccupancyGridmap<option_t,Dim,T,backend_t>>;
    using Ptr      = std::shared_ptr<WeightedOccupancyGridmap<option_t,Dim,T,backend_t>>;
