                  ...
                  cslibs_ndt::matching::Result<cslibs_math_3d::Transform3d> &r)
{
    ...
    const size_t size       = {{static_cast<std::size_t>(static_cast<int>((max(0) - min(0)) / resolution)) + 1,
                                static_cast<std::size_t>(static_cast<int>((max(1) - min(1)) / resolution)) + 1,
                                static_cast<std::size_t>(static_cast<int>((max(2) - min(2)) / resolution)) + 1}};
