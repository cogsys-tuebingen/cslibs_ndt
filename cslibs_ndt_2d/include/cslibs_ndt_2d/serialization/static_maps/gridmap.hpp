...
inline bool save(const cslibs_ndt_2d::static_maps::Gridmap::Ptr &map,
                 const std::string &path)
{
    using path_t  = boost::filesystem::path;
    using paths_t = std::array<path_t, 4>;
    using index_t = std::array<int, 2>;
    using distribution_storage_ptr_t = cslibs_ndt_2d::static_maps::Gridmap::distribution_storage_ptr_t;
    ...
    for (std::size_t i = 0 ; i < 4 ; ++ i) {
        ...
        cslibs_ndt_2d::dynamic_maps::Gridmap::distribution_storage_ptr_t storage_kd(
                    new cslibs_ndt_2d::dynamic_maps::Gridmap::distribution_storage_t());

        storage->traverse([&storage_kd](const index_t &index, const typename cslibs_ndt_2d::static_maps::Gridmap::distribution_t &data) {
...
inline bool load(cslibs_ndt_2d::static_maps::Gridmap::Ptr &map,
                 const std::string &path)
{
    using path_t  = boost::filesystem::path;
    using paths_t = std::array<path_t, 4>;
